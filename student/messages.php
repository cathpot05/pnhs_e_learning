    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                ...
                <?php
                if(isset($_GET['teacherid'])){
                    $sql = "SELECT * FROM tbl_teachers where teacherId = $studentid";
                    //var_dump($sql);
            ...
            <div class="card-body">
                ...
                <?php if(isset($_GET['teacherid'])){?>
                    <form action="sendMessage.php?studentid=<?php echo $id; ?>&teacherid=<?php echo $studentid; ?>" method="post">
                ...
                <table width=100%>
                    <?php if(isset($_GET['teacherid'])){?>
                        <tr>
                            ...
                            <td width=100%><a href="messages.php?teacherid=<?php echo $studentid ;?>" ><?php echo $studentName; ?></a>
                                <hr width=100%></td>

                        </tr>
                    <?php }?>
                    <?php
                    $sql = "SELECT  tbl_teachers.teacherId, tbl_teachers.firstName,tbl_teachers.lastName, tbl_teachers.firstName, tbl_pmessage.message,tbl_pmessage.sendertype FROM tbl_pmessage
						...
						where tbl_pmessage.studentid = $id and tbl_pmessage.teacherid != $studentid GROUP BY tbl_pmessage.teacherid ORDER by id ASC";
...
<script type="text/javascript">
    function refreshData(){
        ...
        var url = 'refreshMessage.php?teacherid=<?php echo $studentid; ?>';
