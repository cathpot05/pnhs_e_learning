...
$sql3 = "SELECT * from tbl_teacherinfo where teacher_id = '".$teacherid."'
AND courseid = '".$courseid."'
AND subjectid = '".$subjid."'";
$result3 = $conn->query($sql3);
if ($result3->num_rows > 0) {
    $row3 = $result3->fetch_assoc();
    $teacherinfo_id = $row3["teacherinfo_id"];
}
//$conn->close();
?>
            ...
            <div class="card-body">
                <table class="table table">
                    ...
                    $sql = "SELECT * FROM tbl_files
                            WHERE teacherinfoid = '".$teacherinfo_id."'
                            ORDER BY quarter DESC, week DESC, id DESC";
