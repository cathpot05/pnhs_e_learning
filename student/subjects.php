            ...
            <div class="card">
                ...
                <div class="card-body">
                    <table class="table table">
                        ...
                        <?php
                        $sql = "SELECT A.studId, B.course, E.subjectDesc, E.subjectid, B.courseid,G.firstName, G.middleName, G.lastName, G.teacherid
                                    FROM tbl_studentinfo A
                                    INNER JOIN tbl_course B ON A.courseId = B.courseid
                                    INNER JOIN tbl_course_subjects C ON B.courseid = C.courseid
                                    INNER JOIN tbl_subject E ON C.subjectid = E.subjectid
                                    INNER JOIN tbl_students D ON A.studId = D.studentId
                                    INNER JOIN tbl_teacherinfo F ON B.courseid = F.courseid AND E.subjectid = F.subjectid
                                    INNER JOIN tbl_teachers G ON F.teacher_id = G.teacherid
                                    WHERE A.studId = $id ";
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="btn-sm">
     								...
     								<a href="viewmodulesubj.php?subjid='.$row["subjectid"].'&courseid='.$row["courseid"].'&teacherid='.$row["teacherid"].'"
