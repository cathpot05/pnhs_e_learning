...
$teacherId = $_GET['teacherId'];
						$sql = "SELECT tbl_pmessage.message,tbl_pmessage.senderType,tbl_pmessage.date,tbl_pmessage.time 
						 FROM tbl_pmessage
						...
						where tbl_pmessage.teacherId = $teacherId and tbl_pmessage.studentId = $id ORDER by pMsg_Id ASC";
