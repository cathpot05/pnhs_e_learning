      ...
      <div class="col-lg-12 main_container">
                    <div class="card">
                      <div class="card-header">
                        <strong>Update Teacher Account's Information</strong> || Fill up the following:
                      </div>
                      <div class="card-body card-block">
                        ...
                        <input type="hidden" value="<?php echo $row['teacherId'];?>" name="id"/>
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input required= "" type="text" id="firstname" name="firstname" value = "<?php echo $row["firstname"];?>" placeholder="Enter Teacher's First Name" class="form-control" onkeyup="lettersOnly(this)" ></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="middlename" class=" form-control-label">Middle Name:</label></div>
                                <div class="col-12 col-md-9"><input required= "" type="text" id="middlename" name="middlename" value = "<?php echo $row["middlename"];?>" placeholder="Enter Teacher's Middle Name" class="form-control" onkeyup="lettersOnly(this)"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="lastname" class=" form-control-label">Last Name:</label></div>
                                <div class="col-12 col-md-9"><input required="" type="text" id="lastname" name="lastname" value = "<?php echo $row["lastname"];?>" placeholder="Enter Teacher's Last Name" class="form-control" onkeyup="lettersOnly(this)"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="address" class=" form-control-label">Address:</label></div>
                                <div class="col-12 col-md-9"><input required="" type="text" id="address" name="address" value = "<?php echo $row["address"];?>" placeholder="Enter Teacher's Address" class="form-control"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="mno" class=" form-control-label">Mobile No.:</label></div>
                                <div class="col-12 col-md-9"><input required="" type="text" id="mno" name="mno" value = "<?php echo $row["mobileno"];?>" placeholder="Enter Teacher's Mobile No." class="form-control" onkeyup="numbersOnly(this)"></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input required= "" type="text" id="username" name="username" value = "<?php echo $row["username"];?>" placeholder="Enter Teacher's Username" class="form-control" onkeyup="lettersOnly(this)" ></div>
                            </div>

                         <!--   <div class="row form-group">
                                <div class="col col-md-3"><label for="password" class=" form-control-label">Password</label></div>
                                <div class="col-12 col-md-9"><input type="password" id="password" name="password" placeholder="Enter Password" class="form-control" value = "<?php echo $row["password"];?>"><span class="help-block"> <i class="fa fa-info"></i> Password serves as default.</span></div>
                            </div>-->


                        <div class="card-footer">
                            <div class="col-6 col-md-6">
                                <button type="submit" class="btn btn-outline-primary btn-lg btn-block">Update Teacher Information</button>
                            </div>
                            <div class="col-6 col-md-6">
