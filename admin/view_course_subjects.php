        ...
        <div class="card">
            ...
            <div class="card-body">
                <table class="table table">
                    ...
                    <tbody>
                    <?php
                    $sql_1 = "SELECT A.sy_course_subjId, B.*, CONCAT(E.firstname , ' ' ,E.lastname) AS teacher, E.teacherId
                        ...
                        INNER JOIN tbl_teachers E ON A.teacherId = E.teacherId
                    ...
                    while($row_1 = $result_1->fetch_assoc()){
                        echo '
     								<tr>
     								<td>'.$row_1["subjDesc"].'</td>
     								<td>'.$row_1["teacher"].'</td>
     								<td>
     								<div class="btn-sm">
                                    <a class="btn btn-outline-danger btn-sm" onClick="removeData('.$row_1["sy_course_subjId"].')" data-toggle="modal" data-target="#deleteModal">Remove Subject</a>
                                 </div>
     								</td>
     								</tr>
     								';
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">Add Subjects for <?php echo $course_desc?></h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="php/add_sy_course_subj.php" method="post" class="form-horizontal">
                    <div class="card-body">
                        <div class="form-group form-inline">
                            <div class="col-md-2 col"><label><input type="checkbox" name="checkall" id="checkall" value="" />  Check All</label></div>
                            <div class="col col-md-4"><label for="sy" class="pull-right form-control-label">Load Subject From</label></div>
                            <div class="col-md-6 pull-right">
                                ...
                                ?>
                                <a class="btn btn-outline-info btn-sm pull-right" id="btnreload" onClick="reloadData(<?php echo $sy_courseId;?>) ">Reload</a>
                            </div>
                        </div>
                        ...
                        <div id="table_content">
                            <div class="row form-group">
                                ...
                                (SELECT subjectId
                                FROM tbl_sy_course_subj WHERE sy_courseId  = $sy_courseId)";
