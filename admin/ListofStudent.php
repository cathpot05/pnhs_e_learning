    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <strong class="card-title">Student's Account List</strong>
            </div>
            <div class="card-body">
                <table class="table table">
                    ...
                    <?php
                    $sql = "SELECT A.*, C.course as 'courseDesc', D.gradeDes
FROM tbl_students A
INNER JOIN tbl_studentinfo B ON A.studentId = B.studId
INNER JOIN tbl_course C ON B.courseId = C.courseid
INNER JOIN tbl_grade D ON B.gradeId = D.gradeid";
                    $result = $conn->query($sql);
                    while($row = $result->fetch_assoc()){
                        echo '
     								<tr>
     								<td> '.$row["frstName"].' '.$row["middleName"].' '.$row["lastName"].'</td>
            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="btn-sm">
     								...
     								<a href="changestudentaccount.php?id='.$row["studentId"].'"
                                    class="btn btn-outline-primary btn-sm">Change  </a>
                                 <br /><br />
     								<a href="php/removestudent.php?id='.$row["studentId"].'" class="btn btn-outline-danger btn-sm">Remove</a>
     								</h3>
     								</td>
     								</tr>
     								';
