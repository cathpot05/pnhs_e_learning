                ...
                <table class="table table">
                    ...
                    while($row = $result->fetch_assoc()){
                        echo '
     								...
     								<td>
                                                <div class="btn-sm">
     							<a href="changestudentaccount.php?id='.$row["studId"].'" class="btn btn-outline-primary btn-sm">Change  </a>
                                 <a href="php/removestudent.php?id='.$row["studId"].'" class="btn btn-outline-danger btn-sm">Remove</a>
                                 </div>
